...
public final class SQLParser {
    ...
    private static Pattern fromTablePattern = null;
    private static Pattern withNamePattern1 = null;
    private static Pattern withNamePattern2 = null;
    private List<Pattern> fromTableAntiPatternList = new ArrayList<>();
	...
	private static final String fromTableAntiRegex = "(ectract\\s{0,}\\()\\s{1,}(from)[\\s]{1,}([a-z_]{1}[a-z0-9_\\.]*)\\)";
